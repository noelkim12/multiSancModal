...
(function (root, factory, sancConst) {
...
})(window,
    {
        ...
        multiSancAnimation : function(sancAction, targetSelector) {
         ...
         */
        fetchProgressSancList: async () => {
            await $N.fetchSimple(CTX_PATH + "/bo/base/sanc/j_list.do")
        },
        /**
         * 결재 정보 DB 조회
         * @param sancSeq
...
// TODO :: 결재선/참조자 정보 TABLE DRAW UTILITY 작성 필요
